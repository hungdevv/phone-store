        ...
        return (
            <header>
                <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                    ...
                    <li>
                        <ul className="social">
                            <li>
                                <a href="http://google.com" className="icons-sm fb-ic">
                                    <i className="fa fa-facebook"> </i>
                                </a>
                            </li>
                            <li>
                                <a href="http://google.com" className="icons-sm pin-ic">
                                    <i className="fa fa-pinterest"> </i>
                                </a>
                            </li>
                            <li>
                                <a href="http://google.com" className="icons-sm gplus-ic">
                                    <i className="fa fa-google-plus"> </i>
                                </a>
                            </li>
                            <li>
                                <a href="http://google.com" className="icons-sm tw-ic">
                    ...
                    <li>
                        <ul className="collapsible collapsible-accordion">
                            <li>
                                <a href="http://google.com" className="collapsible-header waves-effect arrow-r">
            ...
            <i className="fa fa-angle-down rotate-icon" />
                                ...
                                <div className="collapsible-body">
                                    <ul>
                                        <li>
                                            <a href="goo" className="waves-effect">Product Page V.1</a>
                                        </li>
                                        <li>
                                            <a href="https://www.google.com"className="waves-effect">Product Page V.2</a>
                                        </li>
                                        <li>
